...
def test_check_file_signature(start_server, start_client):
    ...
    dir_path = os.path.join(os.path.join(project_root, 'files_for_tests'))
    ...
    client_params_list = [
        ...
        {"command": "CheckLocalFile", "params": {"param1": dir_path, "param2": "Hurricane"}},
    ...
    massages = [
        ...
        f"Received: {dir_path} is a directory, not a file",
